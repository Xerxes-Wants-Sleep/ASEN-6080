...
from filter_18_state import LinearizedKalmanFilter18State, ExtendedKalmanFilter18State
...
from post_processing_18 import run_filter_post_processing_18
...
ekf = ExtendedKalmanFilter18State(
    x0=X0_star,
    P0=P0,
    R=R,
    Q=Q,
...
# -----------------------------
SCRIPT_DIR = Path(__file__).resolve().parent
PLOT_DIR = SCRIPT_DIR / "Plots" / "EKF WS"
...
state_err_18 = X_base - out["Xhat_meas"]
make_state_errors_18_plot(
    out["t_meas"],
    state_err_18,
    PLOT_DIR,
    title="EKF-WS State Error (X_ref - X_hat)",
    filename="state_errors_18_ekf_ws.png",
)
